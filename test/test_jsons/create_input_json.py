...
science = ['solo_L1_phi-hrt-ilam_20210914T071515_V202110260809C_0149140401.fits']
...
input_dict = {
  ...
  'out_dir' : '/data/slam/home/sinjan/hrt_pipe_tests/',  
...
json.dump(input_dict, open(f"./dark_flat_test_apr_2020.json", "w"))