...
phihrt_pipe(sciencedata_fits_filenames, darkfield_fits_filename, flatfield_fits_filename, flat_states = 24, norm_stokes = True, prefilter_f = prefilter_f, 
                   clean_f = True, ctalk_params = c_talk_params, ItoQUV = True, out_demod_file = True, out_dir = '/data/slam/home/sinjan/hrt_pipe_results/stp-144_ctalk_prefilter/', rte = 'False')
#keyword IMGDIRX YES OR NO - image mirrored in y axis - for all HRT images